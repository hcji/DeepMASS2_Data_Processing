# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 15:39:51 2024
...
data_GH11 = np.array(pd.read_csv("Example/Unknown/GH11.csv", header=None))
...
data_G7H = np.array(pd.read_csv("Example/Unknown/G7H.csv", header=None))
...
data_GH17 = np.array(pd.read_csv("Example/Unknown/GH17.csv", header=None))
